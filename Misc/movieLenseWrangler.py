...
# if both files exist
if (os.path.isfile(dataFolderPath + "pMLRatings.csv") and os.path.isfile(dataFolderPath + "pMLMetadata.csv")):
    print(prePend, "pMLRatings.csv and pMLMetadata.csv found... skipping")
# else generate the files
else:
    print(prePend, "Files missing... Generating")
